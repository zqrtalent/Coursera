...
public:
    HashSet(int bucketCount){
        ...
        _hashTable = (ValueContainer**)malloc(sizeof(ValueContainer*)*bucketCount);
        memset(_hashTable, 0, sizeof(ValueContainer*)*bucketCount);
    }
...
public:
    void Add(string name){
        ...
        long hashValue = HashFunction(name);
        if(_hashTable[hashValue] != nullptr){
            ...
            pVal->nextValue = _hashTable[hashValue];
